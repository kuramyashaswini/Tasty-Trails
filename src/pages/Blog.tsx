  ...
  const blogPosts = [
    {
      ...
      excerpt:
        "Discover why homemade food is making a comeback and how it positively impacts your health, family connections, and overall well-being.",
      image:
        "https://images.unsplash.com/photo-1493770348161-369560ae357d?w=500&auto=format&fit=crop&q=80",
    ...
    },
    {
      ...
      excerpt:
        "Learn how to efficiently prepare your meals for the week while maintaining flavor and nutrition. Perfect for busy schedules!",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Demystifying the world of Indian spices and how to use them to enhance your cooking with authentic flavors.",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Explore the delicate balance of spicy, tangy, sweet, and savory elements that make South Indian food so distinctive.",
      image:
    ...
    },
    {
      ...
      excerpt:
        "The benefits of eating according to seasons and how it can improve your health while supporting sustainable food systems.",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Strategies to make healthy food appealing to children while ensuring they get all the nutrients they need.",
      image:
    ...
    },
    {
      ...
      excerpt:
        "How traditional Indian cuisine naturally embraces plant-based eating and ways to incorporate more plants into your diet.",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Unlock the secrets to cooking aromatic, flavorful biryani every time with these expert tips from professional chefs.",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Exploring how time-tested cooking methods like slow cooking and tempering enhance both flavor and nutritional value.",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Practical approaches to eating mindfully and savoring each meal for better digestion and greater satisfaction.",
      image:
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              Explore recipes, cooking tips, nutrition advice, and food stories
          ...
          {isLoading ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[...Array(6)].map((_, i) => (
                <Card
                  key={i}
                  className="overflow-hidden h-[440px] bg-muted/50 animate-pulse"
                >
